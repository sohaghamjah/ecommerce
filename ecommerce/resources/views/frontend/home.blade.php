...
@endphp
    ...
    <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
       ...
       <!-- ============================================== WIDE PRODUCTS : END ============================================== -->
       <!-- ============================================== FEATURED PRODUCTS ============================================== -->
       @include('frontend.layouts.component.home.featuredProduct')
       <!-- /.section -->

        <!-- ============================================== Skip caregory PRODUCTS ============================================== -->
        @include('frontend.layouts.component.home.skipProduct')
        <!-- /.section -->
        <!-- ============================================== Skip category PRODUCTS : END ============================================== -->

        <!-- ============================================== Skip caregory PRODUCTS ============================================== -->
        @include('frontend.layouts.component.home.skipBrandProduct')
        <!-- /.section -->
        <!-- ============================================== Skip category PRODUCTS : END ============================================== -->
